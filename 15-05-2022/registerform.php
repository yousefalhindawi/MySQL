              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" action="" method="POST">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-user fa-lg me-3 fa-fw mb-4 mx-2"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input type="text" id="form3Example1" class="form-control" name='lname'/>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-lock fa-lg me-3 fa-fw mb-4 mx-2"></i>
                    <div class="form-outline flex-fill mb-0">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-key fa-lg me-3 fa-fw mb-4 mx-2"></i>
                    <div class="form-outline flex-fill mb-0">
                  ...
                  <div class="form-check d-flex justify-content-center mb-5">
                    <input class="form-check-input mr-2" type="checkbox" value="" id="form2Example3c" name="terms"/>
